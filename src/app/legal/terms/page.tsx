      ...
      <article className="mx-auto max-w-2xl px-8 py-12">
        ...
        <section className="mt-8 space-y-4 text-sm leading-relaxed text-foreground">
          ...
          <p>
            ...
            ชำระเงินผ่านการโอนเงินและส่งสลิป และรับใบประกาศนียบัตรเมื่อเรียนจบ
          </p>
          ...
          <p>
            การชำระเงินผ่านการโอนเงินจะต้องได้รับการยืนยันจาก admin ก่อนจึงจะสามารถเข้าเรียนได้
            กรณีขอคืนเงิน ผู้ใช้สามารถติดต่อผ่านช่องทางที่ระบุไว้ภายใน 7 วัน
          </p>

          <h2 className="text-lg font-medium">4. ทรัพย์สินทางปัญญา</h2>
          <p>
            เนื้อหาทั้งหมดในคอร์ส รวมถึงวิดีโอ เอกสาร และแบบทดสอบ
            เป็นทรัพย์สินของผู้สร้างคอร์สและ Finalive ห้ามคัดลอกหรือเผยแพร่โดยไม่ได้รับอนุญาต
          </p>
