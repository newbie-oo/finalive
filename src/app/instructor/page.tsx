            ...
            <div className="rounded-card border border-(--border) bg-(--surface) p-6 md:p-8">
              ...
              <div className="mt-4 space-y-4 text-body leading-relaxed text-(--foreground-muted)">
                <p>
                  ...
                  Analyst ที่ KBank Capital Markets ก่อนจะย้ายไปเป็น VP
                  Investment ที่กองทุน hedge fund ในสิงคโปร์ ดูแลพอร์ต US/Asia
                  ex-Japan
                </p>
                <p>
                  ปัจจุบันเป็น independent analyst เขียน research note ให้กับ
                  family office หลายแห่ง และสอนการประเมินมูลค่าหุ้นแบบ practical
