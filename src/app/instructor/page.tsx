		...
		<PublicShell>
			<section className="mx-auto max-w-[720px] px-6 py-16 md:py-24">
				...
				<article className="space-y-6 text-body text-(--foreground-muted)">
					<p>
						Arm เป็นผู้ก่อตั้ง Finalive —
						แพลตฟอร์มการศึกษาด้านการเงินและการลงทุนสำหรับคนทำงานสายการเงินในไทย
						ด้วยประสบการณ์กว่า 10 ปีในวงการวิเคราะห์การลงทุนและการจัดการพอร์ต
					</p>
					<p>
						จุดเริ่มต้นของ Finalive มาจากความต้องการถ่ายทอดความรู้เชิงลึกด้าน Valuation,
						DCF, และ Financial Modeling
						ให้กับนักลงทุนรายย่อยและคนทำงานสายการเงินในรูปแบบที่เข้าใจง่าย ผ่านวิดีโอภาษาไทย
						พร้อมไฟล์ Excel ตัวอย่างจริงที่นำไปใช้ต่อได้ทันที
					</p>
				</article>
