      ...
      <div className="bg-surface-sunken">
        <div className="mx-auto max-w-[1200px] px-6 py-12 md:py-16">
          ...
          <div className="grid gap-10 lg:grid-cols-[1.5fr_1fr] lg:gap-12">
            <div>
              ...
              <div className="mt-6 flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="mt-1 h-3 w-40 animate-pulse rounded-md bg-muted" />
                </div>
              </div>
            ...
            <div className="rounded-card border border-border bg-card p-6 shadow-(--shadow-md)">
              <div className="mb-4 aspect-video w-full animate-pulse rounded-lg bg-muted" />
              <div className="mb-5 h-8 w-24 animate-pulse rounded-md bg-muted" />
        ...
        <div className="mx-auto max-w-[1200px] px-6">
          ...
          <div className="space-y-3">
            {Array.from({ length: 4 }).map((_, i) => (
              ...
              >
                <div className="mt-0.5 h-5 w-5 animate-pulse rounded-sm bg-muted" />
                <div className="h-5 w-full animate-pulse rounded-md bg-muted" />
              </div>
            ))}
          </div>
