			...
			<div className="bg-muted">
				<div className="mx-auto max-w-[1200px] px-6 py-10 md:py-14">
					<div className="mx-auto max-w-2xl text-center">
						<div className="mx-auto mb-2 h-10 w-56 animate-pulse rounded-lg bg-card" />
						<div className="mx-auto h-5 w-80 animate-pulse rounded-md bg-card" />
					</div>
					<div className="mx-auto mt-8 max-w-xl">
						<div className="h-14 w-full animate-pulse rounded-full bg-card shadow-(--shadow-sm-token)" />
					</div>
			...
			<div className="mx-auto max-w-[1200px] px-6 py-8 md:py-10">
				<div className="flex flex-col gap-8 md:flex-row md:items-start">
					<aside className="w-full shrink-0 md:w-[240px]">
						<div className="mb-4 h-10 w-full animate-pulse rounded-button bg-card md:hidden" />
						<div className="space-y-6">
							<div className="rounded-card border border-border bg-card p-4">
								<div className="mb-3 h-4 w-16 animate-pulse rounded-md bg-muted" />
								<div className="space-y-3">
									{Array.from({ length: 5 }).map((_, i) => (
										<div key={i} className="flex items-center gap-2.5">
											...
											<div className="h-3.5 w-6 animate-pulse rounded-md bg-muted" />
										</div>
									))}
								</div>
							</div>
							<div className="rounded-card border border-border bg-card p-4">
								<div className="mb-3 h-4 w-12 animate-pulse rounded-md bg-muted" />
								<div className="space-y-3">
									{Array.from({ length: 5 }).map((_, i) => (
										<div key={i} className="flex items-center gap-2.5">
							...
							<div className="rounded-card border border-border bg-card p-4">
								<div className="mb-3 h-4 w-20 animate-pulse rounded-md bg-muted" />
