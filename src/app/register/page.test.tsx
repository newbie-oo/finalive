...
describe("RegisterPage", () => {
  it("updates strength meter on password input", () => {
    ...
    const bars = document.querySelectorAll("[aria-label='Password strength'] .h-1.rounded-full");
    ...
    const barsAfter = document.querySelectorAll("[aria-label='Password strength'] .h-1.rounded-full");
