...
describe("checkLessonAccess truth table", () => {
	...
	> = [
		...
		[
			"preview wins over not enrolled",
			{ isPreview: true, isFree: false },
			{ isFree: false },
			false,
			true,
	...
	it.each(
		cases,
	)("%s → ok=%p", (_label, lesson, course, enrolled, auth, expectedOk) => {
