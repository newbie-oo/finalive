		...
		getLessons: vi.fn().mockResolvedValue([
			{
				id: "l1",
				title: "Lesson 1",
				bodyMd: "This is a sufficiently long lesson body that contains enough meaningful content to pass the minimum character threshold for publishing a course on the platform.",
				videoMediaId: null,
			},
		]),
		...overrides,
