...
export function CountdownTimer({ expiresAt }: { expiresAt: Date }) {
  ...
  return (
    <div className={`inline-flex items-center gap-2 rounded-full px-3 py-1 text-sm font-mono ${expired ? "bg-destructive/10 text-destructive" : "bg-primary/10 text-primary"}`}>
