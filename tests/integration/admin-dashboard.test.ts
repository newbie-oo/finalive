...
describe("getAdminDashboardCounts", () => {
  ...
  it("counts submitted, today's reviews, active enrollments, and published courses", async () => {
    ...
    await makeSlip({ student: studentA, ref: "FL-A0000001", idem: "ka", slipStatus: "submitted" });
    await makeSlip({ student: studentB, ref: "FL-B0000001", idem: "kb", slipStatus: "submitted" });
    await makeSlip({
      student: studentC,
      ref: "FL-C0000001",
      idem: "kc",
